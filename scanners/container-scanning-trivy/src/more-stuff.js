...
async function main(
  projectId = 'phx-01h1yptgmche7jcy01wzzpw2rf', // Your GCP Project ID
//   imageUrl = 'https://gcr.io/my-project/my-image:123' // Image to attach metadata to
  // If you are using Google Artifact Registry
  imageUrl = 'https://northamerica-northeast1-docker.pkg.dev/phx-01h1yptgmche7jcy01wzzpw2rf/hello-world-app2/hello-world-three' // Image to attach metadata to
) {
